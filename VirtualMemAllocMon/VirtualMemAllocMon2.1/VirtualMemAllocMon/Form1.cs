...
namespace VirtualMemAllocMon
{
    public partial class Form1 : Form
    {
        ...
        public static string[] Flag_to_detection_VAx = new string[18];
        ...
        {
            MessageBox.Show(null, "VirtualMemAllocMon v2.1 [2.1.0.1]\nCode Published by Damon Mohammadbagher , Mar 2022", "About ETW VirtualMemAllocMon v2.1",
