...
------------------------- 
### SysPM2Monitor2.7 & Detection Logs & Memory Scanners (AddressofEntryPoint Technique not Detected by Sysmon Events but Detected vy ETW & ETW VirtualMemAllocMon v1.1), 
