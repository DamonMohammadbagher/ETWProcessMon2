...
+ code performance now is good and "a lot bugs" fixed, Filters added to Processes List Tab & some bugs fixed. 
+ last source/exe update(35) v2.1.35.223 [May 02, 2022]...
```
