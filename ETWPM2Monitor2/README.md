...
+ code performance now is good and "a lot bugs" fixed. in Processes List Tab Take Snapshot also (Beacon TCP Event) Deltatime Checking in "Event Details 1" added to the source code... 
