...
+ code performance now is good and "a lot bugs" fixed, Filters added to processes list Tab & New Detection Event Logs.
+ last source/exe update(35) v2.1.35.210 [Apr 29, 2022]...
```
