...
+ code performance now is good and "a lot bugs" fixed. bugs in Network Connections via APIs Tab fixed & Some Filters Added to Network Connections via Native APIs.
+ last source/exe update(41) v2.1.41.380 [May 20, 2022]...
```
...
----------------------------------------------------------
### ETWPM2Monitor2 v2.1 , update(41) v2.1.41.375 [May 19, 2022] (Bugs in Network Connection via Native APIs Tab fixed & New Filters Added to Network Connections via Native APIs for better performance etc.)
