...
-----------------------------------------------------------    
### ETWPM2Monitor.exe
"ETWPM2Monitor" v1.1 is simple C# code [test version] for Realtime Event Log Monitor, but this code only will work with logname "ETWPM2" which made by "ETWProcessMon2.exe".
