...
+ code performance now is good and "a lot bugs" fixed. bug in version [v2.1.41.380] for Alarms by ETW Tab fixed. (false positive fixed in Alarms by ETW Tab).
+ last source/exe update(42) v2.1.42.392 [May 21, 2022]...
```
Video: https://www.youtube.com/watch?v=DMtMTkAfFNo
